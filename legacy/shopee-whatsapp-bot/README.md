> **Status: legado / não usado na versão atual.**
> Este bot fazia busca e envio 100% automáticos (sem revisão humana) usando `venom-bot`
> para ler/escrever no WhatsApp Web. Foi substituído pelo fluxo manual/semi-automático
> descrito em `docs/nova-versao-mvp-mercadolivre.md` e implementado em `src/`.
